import { m as writeTask } from './app-f4f38cb1.js';
...
const iosTransitionAnimation = () => __sc_import_app('./ios.transition-e115fe4c.js');
const mdTransitionAnimation = () => __sc_import_app('./md.transition-7a03ebcf.js');
...
async function animation(animationBuilder, opts) {
    ...
    const trans = await __sc_import_app('./index-d072b193.js').then(mod => mod.create(animationBuilder, opts.baseEl, opts));
...
export { deepReady as a, lifecycle as b, LIFECYCLE_WILL_UNLOAD as c, LIFECYCLE_WILL_LEAVE as d, LIFECYCLE_DID_LEAVE as e, transition as f, setPageHidden as g };
