import { e as registerInstance, h as createEvent, i as getContext, g as getIonMode, f as h, j as getElement } from './app-f4f38cb1.js';
import { a as attachComponent, b as detachComponent } from './chunk-b3ecd786.js';
import { f as transition } from './chunk-e5490718.js';
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await __sc_import_app('./swipe-back-d94045f8.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
